/*
	AudioManager 2.0 alpha
		* This is the new and improved AudioMan
		* Should be clean and pretty enough to be used in projects
		* You don't need permission to use but feel free to credit me! :D
...
/// <summary>
/// Manages audio either for a whole scene or just a GameObject.
/// </summary>
public class AudioManager : MonoBehaviour
{
	...
	/// <summary>
	/// Lerps the volume of all sounds of a certain audio mixer group from 0 to 1 (original volume)
	/// </summary>
	/// <param name="mixerGroup"></param>
	/// <param name="volume"></param>
	public void ChangeVolumeOfMixerGroup(AudioMixerGroup mixerGroup, float volume)
    {
		Sound[] s = Array.FindAll(sounds, item => item.mixerGroup == mixerGroup);
		if (s == null)
        {
			Debug.LogWarning("No sounds detected from mixer groups: " + mixerGroup);
        }
